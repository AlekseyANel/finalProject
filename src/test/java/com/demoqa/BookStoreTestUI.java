...
public class BookStoreTestUI {
    ...
    String userName = configFileReader.getPropertyFromFile("userName");
    String password = configFileReader.getPropertyFromFile("password");
    MainPage mainPage;
    LoginPage loginPage;
    BooksPage booksPage;
    BookPage bookPage;
    ...
    public void newUserReg () {
        ...
        given()
                ...
                .baseUri(configFileReader.getPropertyFromFile("urlAccount"))
                .basePath("/User")
...
/*        //рекаптча мешает
    ...
    public void getBooks() throws InterruptedException {
        ...
        booksPage.zakasBook();//observe book by author Zakas
